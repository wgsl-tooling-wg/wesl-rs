...
// use super::ParseEntryPoint;

// #[expect(clippy::needless_pass_by_value, reason = "intended API")]
// fn check(input: &str, expected_tree: Expect) {
//     super::check_entrypoint(input, ParseEntryPoint::File, &expected_tree);
// }

// #[expect(clippy::needless_pass_by_value, reason = "intended API")]
// fn check_type(input: &str, expected_tree: Expect) {
//     super::check_entrypoint(input, ParseEntryPoint::Type, &expected_tree);
// }

// #[expect(clippy::needless_pass_by_value, reason = "intended API")]
// fn check_statement(statement: &str, expected_tree: Expect) {
//     super::check_entrypoint(statement, ParseEntryPoint::Statement, &expected_tree);
// }

// #[expect(clippy::needless_pass_by_value, reason = "intended API")]
// fn check_attribute(statement: &str, expected_tree: Expect) {
//     super::check_entrypoint(statement, ParseEntryPoint::Attribute, &expected_tree);
// }
