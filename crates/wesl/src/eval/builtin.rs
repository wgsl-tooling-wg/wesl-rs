...
pub static PRELUDE: LazyLock<TranslationUnit> = LazyLock::new(|| {
    quote_module! {
        ...
        struct __frexp_result_abstract { fract: __AbstractFloat, exp: __AbstractInt }
        ...
        struct __frexp_result_vec2_abstract { fract: vec2<__AbstractFloat>, exp: vec2<__AbstractInt> }
        struct __frexp_result_vec3_abstract { fract: vec3<__AbstractFloat>, exp: vec3<__AbstractInt> }
        struct __frexp_result_vec4_abstract { fract: vec4<__AbstractFloat>, exp: vec4<__AbstractInt> }
        struct __modf_result_f32 { fract: f32, whole: f32 }
        struct __modf_result_f16 { fract: f16, whole: f16 }
        struct __modf_result_abstract { fract: __AbstractFloat, whole: __AbstractFloat }
        ...
        struct __modf_result_vec2_abstract { fract: vec2<__AbstractFloat>, whole: vec2<__AbstractFloat> }
        struct __modf_result_vec3_abstract { fract: vec3<__AbstractFloat>, whole: vec3<__AbstractFloat> }
        struct __modf_result_vec4_abstract { fract: vec4<__AbstractFloat>, whole: vec4<__AbstractFloat> }
